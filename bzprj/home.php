...
<div class="main">
	...
	<center><br>
	<h style="font-family:Times Roman;font-weight:bold;color:red;font-size:30px;">WELCOME TO BEYOND ZERO CAMPAIGN MANAGEMENT SYSTEM</h><br>
	</center>
	<div class="" align="center">
	<h3 style="color:green;">THIS SYSTEM COVERS THE FOLLOWING</h3>
	<table border="0" cellpadding="0" cellspacing="0" >
	<tr style="font-color:red; font-size:20px;"rowspan="5">
	<td >Registration of members<br><br>
	Events Scheduling<br><br>
	Support us Through Donation<br><br>Ticket Booking <br><br>And<br><br>Allocation of Resources <br><br><br>
	</td>
	<tr>
	</table>
	</div>	
